...
skeleton_autograder.check_python_version()
skeleton_autograder.set_allowed_imports(['random', 'collections *', 'collections'])

## COMP 182 Spring 2021 - Homework 4, Problem 3 Test Cases
skeleton_autograder.add_test_case("compute_largest_cc_size", [{"a": set()}], 1)
skeleton_autograder.add_test_case("compute_largest_cc_size", [{"a": set(), "b": set(["c"]), "c": set(["b"])}], 2)
